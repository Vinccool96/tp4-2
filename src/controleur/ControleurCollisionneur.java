...
public class ControleurCollisionneur extends Application {
	...
	final private ObservableList<Ball> balls = FXCollections.observableArrayList();
	...
	private void makeYourDreamsComeTrue(MouseEvent event) {
		createBalls(rayonIO.getValue(), vitesseIO.getValue(), angleIO.getValue(), event.getX(), event.getY(),
	...
	public void start(Stage primaryStage) throws Exception {
		...
		vitesseIO = (Slider) ((VBox) ((GridPane) ((VBox) ((HBox) root.getChildren().get(1)).getChildren().get(0))
				.getChildren().get(0)).getChildren().get(1)).getChildren().get(1);
		angleIO = (Slider) ((VBox) ((GridPane) ((VBox) ((HBox) root.getChildren().get(1)).getChildren().get(0))
				.getChildren().get(0)).getChildren().get(2)).getChildren().get(1);
		rayonIO = (Slider) ((VBox) ((GridPane) ((VBox) ((HBox) root.getChildren().get(1)).getChildren().get(0))
				.getChildren().get(0)).getChildren().get(3)).getChildren().get(1);

		theChosenOne = (ColorPicker) ((VBox) ((GridPane) ((VBox) ((HBox) root.getChildren().get(1)).getChildren()
				.get(0)).getChildren().get(0)).getChildren().get(4)).getChildren().get(1);
